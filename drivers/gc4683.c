...
/* 	ret = gc4683_write_reg(gc4683->client, 0x022c,
			 GC4683_REG_VALUE_08BIT, val);
	ret |= gc4683_write_reg(gc4683->client, 0x0a67,
			 GC4683_REG_VALUE_08BIT, 0x80);
	ret |= gc4683_write_reg(gc4683->client, 0x0a54,
			 GC4683_REG_VALUE_08BIT, 0x0e);
	ret |= gc4683_write_reg(gc4683->client, 0x0a65,
			 GC4683_REG_VALUE_08BIT, 0x10);
	ret |= gc4683_write_reg(gc4683->client, 0x0a98,
			 GC4683_REG_VALUE_08BIT, 0x10);
	ret |= gc4683_write_reg(gc4683->client, 0x05be,
			 GC4683_REG_VALUE_08BIT, 0x00);
	ret |= gc4683_write_reg(gc4683->client, 0x05a9,
			 GC4683_REG_VALUE_08BIT, 0x01);
	ret |= gc4683_write_reg(gc4683->client, 0x0029,
			 GC4683_REG_VALUE_08BIT, 0x08);
	ret |= gc4683_write_reg(gc4683->client, 0x002b,
			 GC4683_REG_VALUE_08BIT, 0xa8);
	ret |= gc4683_write_reg(gc4683->client, 0x0a83,
			 GC4683_REG_VALUE_08BIT, 0xe0);
	ret |= gc4683_write_reg(gc4683->client, 0x0a72,
			 GC4683_REG_VALUE_08BIT, 0x02);
	ret |= gc4683_write_reg(gc4683->client, 0x0a73,
			 GC4683_REG_VALUE_08BIT, otp_val);
	ret |= gc4683_write_reg(gc4683->client, 0x0a75,
			 GC4683_REG_VALUE_08BIT, 0x41);
	ret |= gc4683_write_reg(gc4683->client, 0x0a70,
			 GC4683_REG_VALUE_08BIT, 0x03);
	ret |= gc4683_write_reg(gc4683->client, 0x0a5a,
			 GC4683_REG_VALUE_08BIT, 0x80); 
	...
	ret |= gc4683_write_reg(gc4683->client, 0x0a70,
			 GC4683_REG_VALUE_08BIT, 0x00);
	ret |= gc4683_write_reg(gc4683->client, 0x0080,
			 GC4683_REG_VALUE_08BIT, 0x02);
	ret |= gc4683_write_reg(gc4683->client, 0x0a67,
			 GC4683_REG_VALUE_08BIT, 0x00);
*/
